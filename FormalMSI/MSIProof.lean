...
theorem simInv_parent_push {n : Nat} {m : MSIState n} {s : SeqState n} (h : SimInv m s)
  ...
  · intro hp j
    ...
    · subst hj
      simp only [upd_self]
      exact clean_congr he1 he2 he3 (clean_pc_append (h.epochI hp j).2 h1 h2)
    · simp only [upd_other _ _ _ _ hj]
      exact (h.epochI hp j).2
  · intro hp j k hj hk
  ...
  · intro hp j
    ...
    · subst hj
      simp only [upd_self]
      rcases h.epochM_slot hp j with ⟨hsh, htok⟩ | ⟨hsh, hcl⟩
      · exact Or.inl ⟨hsh, mtoken_congr he1 he2 he3 (mtoken_pc_append htok h1 h2)⟩
      · exact Or.inr ⟨hsh, clean_congr he1 he2 he3 (clean_pc_append hcl h1 h2)⟩
    · simp only [upd_other _ _ _ _ hj]
      exact h.epochM_slot hp j
  · intro hp hall
    exact h.epochM_val hp hall
  ...
  · intro hp j
    ...
    · subst hj
      simp only [upd_self]
      rcases h.epochS_slot hp j with ⟨hsh, htok⟩ | ⟨hsh, hcl⟩
      · exact Or.inl ⟨hsh, stoken_congr he1 he2 he3 (stoken_pc_append htok h1 h2)⟩
      · exact Or.inr ⟨hsh, clean_congr he1 he2 he3 (clean_pc_append hcl h1 h2)⟩
    · simp only [upd_other _ _ _ _ hj]
      exact h.epochS_slot hp j
